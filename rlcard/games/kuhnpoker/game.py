...
from rlcard.games.kuhnpoker import Dealer
from rlcard.games.kuhnpoker import Player
from rlcard.games.kuhnpoker import Judger
from rlcard.games.kuhnpoker import Round
...
class KuhnPokerGame(Game):
    ...
    def __init__(self, allow_step_back=False):
        ...
        # Set blinds to be the same to act as ante
        self.small_blind = 1
    ...
    def init_game(self):
        ...
        # the big blind and the small blind needs to
        ...
        # Count the round. There is one round in each game.
    ...
    def step(self, action):
        ...
        if self.allow_step_back:
            ...
            ps_hand = [
                copy(self.players[i].hand)
                for i in range(self.num_players)
            ]
            self.history.append((r, r_raised, gp, r_c, d_deck, ps, ps_hand))
    ...
    def step_back(self):
        ...
        if len(self.history) > 0:
            (self.round, r_raised,
             ...
             d_deck, self.players, ps_hand) = self.history.pop()
...
#    game = KuhnPokerGame(allow_step_back=True)
#    while True:
#        print('New Game')
